...
public:
	...
	double* GetMousePositionChange() { return MousePosChange; }
...
private:
	...
	double MousePosChange[2]{ 0.0 };

	double MouseLastX, MouseLastY;// , MouseXChange, MouseYChange;
...
void Window::HandleMouse(GLFWwindow* WindowIn, double XPos, double Ypos)
{
	...
	TheWindow->MousePosChange[0] = XPos - TheWindow->MouseLastX;
	TheWindow->MousePosChange[1] = TheWindow->MouseLastY - Ypos;
